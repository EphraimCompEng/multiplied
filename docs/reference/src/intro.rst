...
multiplicity is a powerful tool to build, test, and analyse multiplier designs.
...
multiplicity is built to streamline this process:

- Custom partial product reduction via `templates <https://github.com/EphraimCompEng/multiplicity/blob/master/docs/structures/templates.md>`__
